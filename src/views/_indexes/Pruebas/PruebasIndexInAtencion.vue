      ...
      <v-dialog v-model="dialog"  persistent max-width="600px" >
        <v-card>
          ...
          <v-card-text>
                  ...
                  <v-select :items="tipo_prueba" label="Tipo" item-text="nombre" required v-model="prueba.tipoprueba" return-object></v-select>

                    <v-text-field name="fecprueba"  label="fec. prueba" v-model="prueba.fecprueba"
                    type="date" color="main_color" hide-details="auto" />

                    <v-text-field name="fecresultado" label="fec. resultado"  v-model="prueba.fecresultado"
                    type="date" color="main_color" hide-details="auto" />

                    <v-text-field name="resultado" label="resultado"  v-model="prueba.resultado"
                    type="text" color="main_color" hide-details="auto" />

                    <v-text-field name="observacion" label="observacion"  v-model="prueba.observacion"
                    type="text" color="main_color" hide-details="auto" />
