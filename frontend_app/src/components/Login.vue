<template> <!-- https://github.com/zakaria-29-dev/Vuejs-Vuetify-Login-Application-Moden/blob/main/src/views/Home.vue -->
    <v-app id="inspire">
      <v-main style="background-image: url(../assets/hands-of-unrecognizable-female-doctor-writing-on-form-and-typing-on-laptop-keyboard.jpg);">
                        ...
                        <v-card-text class="mt-12">
                          ...
                          <div class="text-center mt-4">
                            <v-btn class="mx-2" fab color="black" outlined>
                              <v-icon>fab surface-area</v-icon>
                            </v-btn>
                            <v-btn class="mx-2" fab color="black" outlined>
